                ...
                <div class="card m-0">
                    <div class="card-header p-2">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <?php echo e(Form::select('warehouse_id', $warehouses, '', ['class' => 'form-control select warehouse_select ', 'id' => 'warehouse', 'required' => 'required'])); ?>
                                    ...
                                    <?php if(session($lastsegment) && !empty(session($lastsegment)) && count(session($lastsegment)) > 0): ?>
                                        <?php $__currentLoopData = session($lastsegment); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                                ...
                                                $is_grams = $product->grams === 1; // Check if product is sold by grams
                                                $product_price = $is_grams ? $product->price_per_gram : $product->price; // Set price based on grams or unit
                                                $quantity_value = $details['quantity']; // Maintain existing quantity value

                                                if ($is_grams) {
                                                    $quantity_value .= ' grams'; // Add grams unit to quantity display
                                                }
                                            ?>
                                            ...
                                            <tr data-product-id="<?php echo e($id); ?>"
                                                ...
                                                <?php if($product->grams): ?>
                                                    <td>
                                                        <span class="quantity buttons_added">
                                                            ...
                                                            <input type="number" step="0.01" min="0.01"
                                                                ...
                                                                value="<?php echo e($quantity_value); ?>">
                                                    ...
                                                    <td class="col-sm-3 mt-2">
                                                        <span
                                                            class="subtotal"><?php echo e(Auth::user()->priceFormat($product_price * $details['quantity'])); ?></span>
                                                    </td>
                                                <?php else: ?>
                                                    <td>
                                                        <span class="quantity buttons_added">
...
<?php /**PATH /var/www/resources/views/pos/index.blade.php ENDPATH**/ ?>